...
public class MainService {
    ...
    public MainDataDto getDefaultMainData(String keyword,String sort) {
        ...
        Note targetNote = sortedNoteList.get(0);
        ...
        MainDataDto mainDataDto = new MainDataDto(notebookList, targetNotebook, sortedNoteList, targetNote, searchedNotebookList, searchedNoteList, tagList);
        return mainDataDto;
    }
